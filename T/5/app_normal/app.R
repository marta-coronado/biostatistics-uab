...
# setwd("~/Insync/1244149@uab.cat/OneDrive Biz/DOCENCIA/Genètica/Bioestadística/Curso 26-27/github/biostatistics-uab/T/5/app_normal")
# shinylive::export(appdir = "../app_normal/", destdir = "docs")
