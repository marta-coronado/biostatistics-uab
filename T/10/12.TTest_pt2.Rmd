...
> Para una muestra de tamaño $n$ con una media $\bar{x}$ y desviación estánda $s$, el IC bilateral con un nivel de confianza $100(1-\alpha)$% es:
...
<center>
<img src="img/CriticalRegion.png" width=80%>
</center>
...
$((\bar{x}_{1}-\bar{x}_2) \pm t_{df}\times SE)$
...
<br>
> En los problemas "a mano" se calculan los gl como $n_1+n_2-2$, generalmente asumen que la varianza es igual entre muestras (_se cumplen los requisitos para la inferencia_)
...
| **2 muestras independientes*** | $t = \frac{\bar{x}_1 - \bar{x}_2}{\sqrt{s^2_1/n_1 + s^2_2/n_2}}$ | Welch-Satterthwaite | $(\bar{x}_1 - \bar{x}_2) \pm t_{df} \, \sqrt{s^2_1/n_1 + s^2_2/n_2}$ |
