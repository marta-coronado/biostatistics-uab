...
Podemos agregar la significación estadística con el paquete `ggsignif`.
...
- Crea una nueva visualización con alguno de los `geom_` que hemos visto u otro, como por ejemplo `geom_line()`, `geom_violin()`, ...
- Utiliza los datos de la simulación (puedes leerlos directamente con el link!):

```{r}
library(readr)

surv_raw <- "https://raw.githubusercontent.com/marta-coronado/biostatistics-uab/refs/heads/main/T/2/data/ebola_epidemic.tab"

surv_raw <- read_tsv(surv_raw, col_names = T)
```
...
organ_df <- data.frame(organ = c("heart", "leukocyte", "nerve", "brain", "liver", "stomach", "colon"), 
 type = c("circulation", "immune system",  "nervous system", "nervous system", "digestion", "digestion", "digestion"), 
 colour = c("red", "red", "purple", "purple", "orange", "orange", "orange"), 
 value = c(10, 5, 1, 8, 2, 5, 5),
 stringsAsFactors=F)
```

```{r echo=TRUE, fig.height=4.7, fig.width=4.8}
library(gganatogram)
...
- La complejidad y las características de algunos datos biológicos requieren herramientas especializadas.
    + Las extensiones de `ggplot2` pueden ser útiles.
