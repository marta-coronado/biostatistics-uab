...
## Test de dos colas y CI: p-valor
...
$$
z = \frac{\bar{x}-\mu}{SE}=\frac{166.5-170}{2}=-1.75
$$
...
> Conclusión: la muestra **proporciona evidencia suficiente** para afirmar que la altura media es menor de 170cm.
