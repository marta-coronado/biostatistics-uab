...
Ejemplo con la altura de personas adultas:
  ...
  - La media de altura en una muestra de 60 adultos es $\bar{x}_{altura} = 170 cm$.
...
b) Queremos calcular la probabilidad de que una muestra de 100 bombillas funcione en promedio más de 1524h.
...
**Si $\sigma$ es conocida se usa $\sigma$ en lugar de $s$.**
...
> **¿Entre qué valores se encuentra el 80% central de la duración de los neumáticos de esta marca?**

--

#### Paso 1: Determinar $\alpha$ y $z$ crítico

- Área central deseada: 80% → $\alpha = 1 - 0.8 = 0.2$  
...
**Intervalo central del 80%:**  
$$
(44160, 51840)
$$

> **El 80% de los neumáticos de esta marca duran entre 44,160 km y 51,840 km.**
