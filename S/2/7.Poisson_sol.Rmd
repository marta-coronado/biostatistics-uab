...
- Para todos los peces, la tasa de éxito por hora es de 0.667.

$$
\lambda = 0.667/1h
$$
- Si queremos estudiar un intervalo de 7h, podemos ajustar la tasa:

$$
\lambda = 0.667 \times 7 = 4.7
$$
- La probabilidad de que en 7 horas pesquemos 3 o menos se obtiene calculando la distribución de Poisson para $r = 0, 1, 2, 3$.

.pull-left[
$$
P(0)=\frac{e^{-4.7}4.7^0}{0!}=0.01
$$
$$
P(1)=\frac{e^{-4.7}4.7^1}{1!}=0.04
$$
]
.pull-right[
$$
P(2)=\frac{e^{-4.7}4.7^2}{2!}=0.1
$$
$$
P(3)=\frac{e^{-4.7}4.7^3}{3!}=0.16
$$
]
...
- La probabilidad de pescar 4 o más en 7h es $P(r\ge4)=1-P(0)-P(1)-P(2)-P(3)=0.69$, es decir, 69%.
