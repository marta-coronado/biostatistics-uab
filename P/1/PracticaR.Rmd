...
Lee en `R` el archivo ["**GSE68849_expression.csv**"](https://github.com/marta-coronado/biostatistics-uab/blob/main/P/1/data/GSE68849_expression.csv) que encontrarás en la carpeta [**data**](https://github.com/marta-coronado/biostatistics-uab/blob/main/P/1/data/). 
...
Para saber el tipo de variable que contiene `expressionData`, podemos utilizar la función `str(DATA.FRAME)`. Rellena la siguiente tabla indicando qué tipo de variable contiene el `data.frame expressionData`.
...
Calcula la media del nivel de expresión para cada tratamiento. Deberás combinar `group_by()` y `summarize()`. La [diapositiva 42](https://marta-coronado.github.io/biostatistics-uab/T/2/2.IntroR.html#62) puede servir de guía:
