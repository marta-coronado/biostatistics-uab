...
Lee en `R` el archivo "`GSE68849_expression.csv`" que encontrarás en la carpeta **data**. Puedes abrirlo primero con Excel o con otro programa de visualización de datos (como un editor de texto) para comprobar si tiene nombres de columnas y cómo están separadas.  
...
exp.heatmap <- exp.heatmap +
  labs(x = "???", y = "???") + 
  theme(axis.text.x = element_text(angle = ???, vjust = 0.5)) # Rotar les etiquetes de l'eix x
exp.heatmap
